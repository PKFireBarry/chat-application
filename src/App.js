      ...
      <div className="App bg-slate-200 w-screen over h-screen bg-gradient-to-r from-indigo-200 via-purple-700 to-red-500">
          {!isAuth ? 
              ...
              <div className=" bg-slate-600 ">
                  {rooms ? (
                      <div>
                          <Chat setIsAuth={setIsAuth} handleSubmit={handleSubmit} setRooms={setRooms} rooms={rooms}/>
                      </div>
                  ) : (
                      <div className="relative min-h-screen bg-gradient-to-r from-indigo-700 via-purple-500 to-red-500">
                          <div className="mb-20 p-4">
                              <h2 className="text-center text-white text-3xl font-semibold py-8 underline">Open Chat Rooms</h2>
                              <p className="text-white text-center">To join a chat room, click on the room name. To create a new room, enter a name in the input field below and click the "Create" button.</p>
                              {roomList.map((room, index) => (
                                  <div className="bg-gray-800 rounded-lg my-4 px-4 h-14 py-4 hover:bg-gray-700 cursor-pointer" key={index} onClick={() => setRooms(room)}>
                                      <p className="text-white">Chat Room: 
                          ...
                          <div className="fixed bottom-0 w-full bg-gray-900">
                              <div className="container mx-auto py-4">
                                  ...
                                  <p className="text-center text-lg font-semibold mb-8 underline text-white">Welcome! This is the best place to find new people &amp; make new friendships!</p>
                                  <div className="flex items-center ">
                                      <button className="px-4 py-2 mr-2 bg-gray-700 rounded-lg text-white hover:bg-gray-800" onClick={() => setIsAuth(null)}>Logout</button>
...
<div className="relative min-h-screen bg-gradient-to-r from-indigo-700 via-purple-500 to-red-500">
  <div className="mb-20 p-4">
    ...
    <p className="text-white text-center">
      To join a chat room, click on the room name. To create a new room, enter a name in the input field below and click the "Create" button.
    </p>
    {roomList.map((room, index) => (
      <div className="bg-gray-800 rounded-lg my-4 px-4 h-14 py-4 hover:bg-gray-700 cursor-pointer" key={index} onClick={() => setRooms(room)}>
        <p className="text-white">Chat Room: 
